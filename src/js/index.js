let practiceData = [
  ...
  },
  {
    name: '身分證',
    description:
      'Hahow 動畫互動網頁程式入門課程練習，使用 SCSS @mixin, @function 語法。',
    link: 'IDCard/dist',
    date: '2019/10/14',
  },
  {
    name: 'CSS 顏色選擇器',
    description:
      '列出所有 HTML 顏色名，方便選取顏色。<br>使用 overflow 與給定 height 值，讓頁面滾動到邊界不會彈回，視覺更具穩定性。實作 Tooltip，偵測滑鼠在元素的位置，並顯示。實作複製頁面內容到使用者剪貼板功能，方便操作。',
    link: 'colorPicker/dist',
    date: '2019/10/14',
  },
  {
    name: 'Read Clipboard',
  ...
  },
  {
    name: 'To-Do List',
    description:
      '使用 JQuery 實作簡易備忘錄，將資料儲存在 localStorage，使網頁重載後不會消失。<br>用來比較使用 Vue.js 後的優點。',
    link: 'todoList/dist',
    date: '2019/10/14',
  },
  {
  ...
  },
  {
    name: '空氣品質指標',
    description:
      '串接行政院環境保護署opendata API，顯示各縣市監測站 AQI，並可添加關注城市，練習使用 Vue component, props 與 $emit。',
